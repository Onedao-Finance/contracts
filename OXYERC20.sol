...
contract OXY is ERC20Permit, Ownable {
    ...
    constructor() ERC20("OXY", "OXY", 9) ERC20Permit() {
    ...
    /**
        @notice increases OXY supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess OXY
